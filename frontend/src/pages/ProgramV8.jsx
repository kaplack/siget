...
const Programacion = () => {
  ...
  const handleDragEnd = (event) => {
    ...
    // Prevent cycles: draggedItem must not move into its own subtree
    const isDescendant = (parentId, childId) => {
      const tree = buildTree(flat);
      const stack = [tree.find((n) => n.id === parentId)];
    ...
    // Update parentId to make draggedItem a child of targetItem
